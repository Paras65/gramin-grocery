...
1. [Overview & Quick Start](#1-overview--quick-start)
   ...
   - [Homepage Share Option & Social Link Preview (साथी दुकानदार को ऐप शेयर करें व Instagram/WhatsApp प्रीव्यू)](#homepage-share-option--social-link-preview-साथी-दुकानदार-को-ऐप-शेयर-करें-व-instagramwhatsapp-प्रीव्यू)
   - [Frequently Asked Questions (अक्सर पूछे जाने वाले सवाल - FAQs)](#frequently-asked-questions-अक्सर-पूछे-जाने-वाले-सवाल---faqs)
2. [Quick Billing & POS (तुरंत बिलिंग)](#2-quick-billing--pos-तुरंत-बिलिंग)
   ...
   - [Quick Add Customer & Searchable Picker (+ नया ग्राहक व त्वरित खोज)](#quick-add-customer--searchable-picker-नया-ग्राहक-व-त्वरित-खोज)
   - [Cash Tender & Change Return Calculator (नकद छुट्टे पैसे कैलकुलेटर)](#cash-tender--change-return-calculator-नकद-छुट्टे-पैसे-कैलकुलेटर)
   - [0-Stock & Low-Stock Visual Highlights (0-स्टॉक व कम स्टॉक चेतावनी बैज)](#0-stock--low-stock-visual-highlights-0-स्टॉक-व-कम-स्टॉक-चेतावनी-बैज)
...
17. [Village Subscription Plans & Transparent Pricing (दुकान प्लान व सुविधाएं)](#17-village-subscription-plans--transparent-pricing-दुकान-प्लान-व-सुविधाएं)
    ...
    - [14-Day Complimentary Pro Trial (🎁 14-दिन मुफ़्त प्रो ट्रायल)](#14-day-complimentary-pro-trial-14-दिन-मुफ़्त-प्रो-ट्रायल)
    - [Merchant "Refer & Earn 15 Days Free Pro" Program (दुकानदार रेफरल प्रोग्राम: 15 दिन प्रो मुफ़्त)](#merchant-refer--earn-15-days-free-pro-program-दुकानदार-रेफरल-प्रोग्राम-15-दिन-प्रो-मुफ़्त)
    - [Direct Dynamic UPI QR Code & Instant Pro Upgrade (डायरेक्ट UPI QR कोड व 1-टैप प्रो अपग्रेड)](#direct-dynamic-upi-qr-code--instant-pro-upgrade-डायरेक्ट-upi-qr-कोड-व-1-टैप-प्रो-अपग्रेड)
    - [Offline Voucher & Coupon Redemption (कूपन व एक्टिवेशन कोड से तुरंत प्रो चालू करें)](#offline-voucher--coupon-redemption-कूपन-व-एक्टिवेशन-कोड-से-तुरंत-प्रो-चालू-करें)
    - [Pro Feature Guards & 1-Tap Upgrade Doors (प्रो सुविधा सुरक्षा व त्वरित अपग्रेड)](#pro-feature-guards--1-tap-upgrade-doors-प्रो-सुविधा-सुरक्षा-व-त्वरित-अपग्रेड)
...
19. [Platform Administration & Store Support (सुपर एडमिन व दुकान सहायता)](#19-platform-administration--store-support-सुपर-एडमिन-व-दुकान-सहायता)
    ...
    - [UPI Payment Claims Verification & Instant Pro Activation (यूपीआई भुगतान सत्यापन व प्रो एक्टिवेशन)](#upi-payment-claims-verification--instant-pro-activation-यूपीआई-भुगतान-सत्यापन-व-प्रो-एक्टिवेशन)
    - [Single-Use Pro Voucher Management & Anti-Bypass System (सिंगल-यूज़ प्रो वाउचर प्रबंधन व सुरक्षा)](#single-use-pro-voucher-management--anti-bypass-system-सिंगल-यूज़-प्रो-वाउचर-प्रबंधन-व-सुरक्षा)
    - [Campaign & Festive Voucher Generation (त्योहारी व प्रमोशनल अभियान वाउचर)](#campaign--festive-voucher-generation-त्योहारी-व-प्रमोशनल-अभियान-वाउचर)
    - [Pro Subscription Intelligence, Days Countdown & Pause-Resume (प्रो सदस्यता विवरण, शेष दिन रडार व पॉज़-रिज़्यूम नियंत्रण)](#pro-subscription-intelligence-days-countdown--pause-resume-प्रो-सदस्यता-विवरण-शेष-दिन-रडार-व-पॉज़-रिज़्यूम-नियंत्रण)
    - [Universal Bulk Store & Subscription Controls (सार्वभौमिक बल्क प्रो व स्टोर नियंत्रण)](#universal-bulk-store--subscription-controls-सार्वभौमिक-बल्क-प्रो-व-स्टोर-नियंत्रण)
    ...
    - [Store 360° Inspector & Granular Module Controls (360° दुकान नियंत्रण व मॉड्यूल स्विचबोर्ड)](#store-360-inspector--granular-module-controls-360-दुकान-नियंत्रण-व-मॉड्यूल-स्विचबोर्ड)
    - [Multi-Store Storage Footprint & Upgrade Lead Pipeline (डेटा स्टोरेज रडार व प्रो अपग्रेड एनालिटिक्स)](#multi-store-storage-footprint--upgrade-lead-pipeline-डेटा-स्टोरेज-रडार-व-प्रो-अपग्रेड-एनालिटिक्स)
    ...
    - [Proxy, Threat Intelligence & Fraud Radar (प्रॉक्सी, वीपीएन व धोखाधड़ी पहचान रडार)](#proxy-threat-intelligence--fraud-radar-प्रॉक्सी-वीपीएन-व-धोखाधड़ी-पहचान-रडार)
    - [Multi-Store IP Collision & CSC Village Kiosk Detection (समान IP पर कई दुकानें व ग्रामीण CSC कियोस्क पहचान)](#multi-store-ip-collision--csc-village-kiosk-detection-समान-ip-पर-कई-दुकानें-व-ग्रामीण-csc-कियोस्क-पहचान)
    - [Duplicate UTR Payment Fraud Radar (समान UTR चोरी व धोखाधड़ी रोकथाम)](#duplicate-utr-payment-fraud-radar-समान-utr-चोरी-व-धोखाधड़ी-रोकथाम)
    - [1-Click Immediate Store Freeze & Unsuspend Controls (1-क्लिक तुरंत खाता निलंबन व बहाली)](#1-click-immediate-store-freeze--unsuspend-controls-1-क्लिक-तुरंत-खाता-निलंबन-व-बहाली)
    - [Live Platform Security Audit Log Stream (लाइव सुरक्षा ऑडिट लॉग व सत्यापन)](#live-platform-security-audit-log-stream-लाइव-सुरक्षा-ऑडिट-लॉग-व-सत्यापन)
    - [Mobile-First Admin Layout & Zero Horizontal Scroll (स्मार्टफोन-अनुकूल सुपर एडमिन लेआउट)](#mobile-first-admin-layout--zero-horizontal-scroll-स्मार्टफोन-अनुकूल-सुपर-एडमिन-लेआउट)
    - [Store Account Security & Isolation (दुकान डेटा व खाता सुरक्षा)](#store-account-security--isolation-दुकान-डेटा-व-खाता-सुरक्षा)
    - [Data Privacy Safeguards & High-Speed Platform Communication (डेटा गोपनीयता सुरक्षा व उच्च-गति मंच संचार)](#data-privacy-safeguards--high-speed-platform-communication-डेटा-गोपनीयता-सुरक्षा-व-उच्च-गति-मंच-संचार)
...
### Homepage Share Option & Social Link Preview (साथी दुकानदार को ऐप शेयर करें व Instagram/WhatsApp प्रीव्यू)
- **गाँव के साथी व्यापारियों के साथ साझा करें:** होमपेज के शीर्ष नेविगेशन बार और मुख्य पृष्ठ पर **"साथी दुकानदार को शेयर करें"** का समर्पित कार्ड उपलब्ध है।
- **1-टैप WhatsApp व Instagram शेयर:**
  - **WhatsApp शेयर:** केवल 1 टैप में WhatsApp खुलता है, जिसमें ऐप की मुख्य खूबियाँ (100% ऑफ़लाइन, ₹0 आजीवन मुफ़्त, बारकोड स्कैनर, 52 ग्रामीण सामान) और रेफरल लाभ से युक्त संदेश पहले से लिखा मिलता है।
  - **Instagram व अन्य ऐप्स:** मोबाइल पर सिस्टम शेयर शीट द्वारा Instagram Direct Messages, Stories या Feed में लिंक साझा किया जा सकता है।
  - **1-क्लिक लिंक कॉपी:** Instagram Bio या किसी अन्य सोशल मीडिया पर लगाने के लिए सुरक्षित 1-क्लिक कॉपी लिंक बटन (2.5 सेकंड का *"लिंक कॉपी हो गया! ✅"* पुष्टि संदेश)।
- **आकर्षक सोशल लिंक प्रीव्यू (Meta/Instagram Open Graph Preview):** जब भी यह लिंक WhatsApp या Instagram पर भेजा जाता है, तो प्राप्तकर्ता को दुकान के लोगो, 100% ऑफ़लाइन गारंटी और मुफ़्त स्टार्टर प्लान का स्पष्ट व आकर्षक प्रीव्यू कार्ड दिखाई देता है।
- **रेफरल प्रो बोनस:** साथी दुकानदार को जोड़ने पर दोनों को 15 दिन का ग्रामिन प्रो प्लान मुफ़्त प्राप्त होता है।

### Frequently Asked Questions (अक्सर पूछे जाने वाले सवाल - FAQs)
- **गाँव के दुकानदारों की मुख्य जिज्ञासाओं का तुरंत समाधान:** होमपेज पर पारदर्शी मूल्य तालिका के नीचे अक्सर पूछे जाने वाले 7 प्रमुख सवालों का इंटरएक्टिव एकॉर्डियन उपलब्ध है:
  1. **100% ऑफ़लाइन कार्यप्रणाली:** कमजोर नेटवर्क या बिजली कटौती में भी बिना रुके सुपरफ़ास्ट बिलिंग व बही-खाता संचालन।
  2. **₹0 गाँव स्टार्टर मुफ़्त गारंटी:** बिना किसी छिपे शुल्क के आजीवन मुफ़्त स्टार्टर प्लान।
  3. **फोन खराब या चोरी होने पर डेटा सुरक्षा:** 1-क्लिक ऑफ़लाइन बैकअप व प्रो क्लाउड ऑटो-सिंक द्वारा नए फोन में तुरंत खाता बहाली।
  4. **महंगे कंप्यूटर व प्रिंटर की आवश्यकता नहीं:** साधारण 4G एंड्रॉयड स्मार्टफोन के कैमरे से बारकोड स्कैनिंग और सस्ते पॉकेट ब्लूटूथ प्रिंटर का समर्थन।
  5. **ग्राहकों को WhatsApp रसीद व डिजिटल पासबुक:** 1-टैप में ग्राहक को विस्तृत रसीद और फोन पर पूरा उधारी इतिहास देखने हेतु पासबुक लिंक।
  6. **मुनीम/स्टाफ से मुनाफ़ा व खरीद भाव गोपनीयता:** 4-अंकों के मुनीम PIN द्वारा थोक खरीद भाव, कुल मुनाफ़ा और गल्ला हिसाब की पूर्ण सुरक्षा।
  7. **15 से 30 सेकंड में दुकान सेटअप:** 52 प्रसिद्ध ग्रामीण किराना सामानों के 1-क्लिक लोड के साथ तुरंत शुरुआत।
- **सीधे रजिस्ट्रेशन सुविधा:** सवाल के भीतर से ही 1-क्लिक में दुकान रजिस्ट्रेशन फॉर्म पर जाने का त्वरित विकल्प।
...
### Bill Hold & Resume: Queue & Crowd Management (बिल होल्ड व रिज़्यूम: काउंटर भीड़ प्रबंधन)
- **भीड़ के समय काउंटर रुकावट से मुक्ति:** गाँव की दुकान में सुबह व शाम ग्राहकों की भारी भीड़ होती है। अक्सर कोई ग्राहक 5 सामान तुलवाने के बाद कहता है *"1 मिनट, धनिया भी ले आता हूँ"* या पैसे लाने घर चला जाता है। ऐसे में पूरे काउंटर की लाइन रुक जाती थी।
- **1-टैप बिल होल्ड (Pause Bill):** बिलिंग कार्ट में खाली करने के बगल में दिए गए **"होल्ड"** बटन पर टैप करते ही चालू बिल तुरंत सुरक्षित मेमोरी में चला जाता है और स्क्रीन तुरंत खाली हो जाती है। दुकानदार बिना 1 सेकंड गंवाए अगले ग्राहक का बिल काटना शुरू कर सकता है।
- **सक्रिय होल्ड अलर्ट पट्टी (Held Bills Banner):** जब भी कोई बिल होल्ड पर होता है, काउंटर के शीर्ष पर और मोबाइल स्क्रीन के नीचे अंबर रंग की स्पष्ट पट्टी दिखती है: *"X बिल होल्ड पर सुरक्षित हैं [देखें / वापस लाएं ➔]"*।
- **1-क्लिक बिल रिज़्यूम (Resume Bill):** ग्राहक के लौटते ही **"बिल वापस लाएं"** दबाएं। उसका पूरा सामान, तय वजन, संशोधित दर, दी गई छूट, और चुना हुआ खाता ज्यों का त्यों स्क्रीन पर वापस आ जाता है।
- **पुराने होल्ड बिल प्रबंधन:** होल्ड सूची में ग्राहक का नाम, सामानों की संख्या, कुल रकम, और होल्ड करने का समय साफ दिखता है। यदि ग्राहक सामान नहीं लेता, तो कचरा पेटी आइकन दबाकर उसे हटाया भी जा सकता है।

### Quick Add Customer & Searchable Picker (+ नया ग्राहक व त्वरित खोज)
- **कार्ट छोड़े बिना तुरंत नया खाता:** उधार या यूपीआई बिलिंग के दौरान यदि कोई नया ग्राहक आ जाए, तो पहले दुकानदार को कार्ट रद्द करके बही-खाते में जाना पड़ता था। अब बिलिंग ड्रॉवर के अंदर ही **"+ नया ग्राहक जोड़ें"** बटन दिया गया है।
- **5 सेकंड में सुपर-फास्ट पंजीकरण:** केवल ग्राहक का नाम, 10-अंकों का मोबाइल नंबर (ऐच्छिक), मोहल्ला/पारा (उदा. पटेल पारा) और उधारी सीमा दर्ज करके **"खाता बनाएं व चुनें"** दबाएं।
- **शून्य रुकावट गारंटी:** नया खाता तुरंत बही-खाते में सुरक्षित हो जाता है और चालू बिल में खुद ब खुद चुन लिया जाता है। पहले से पंच किए गए किसी भी सामान या वजन में कोई बदलाव नहीं होता।
- **100+ खातों में त्वरित लाइव सर्च:** गाँव में 100 से अधिक खातेदार होने पर ड्रॉपडाउन में ढूंढने की जगह सर्च बॉक्स दिया गया है। नाम, मोबाइल नंबर या पारा लिखते ही चुटकियों में संबंधित ग्राहक सामने आ जाते हैं।
- **बकाया व सीमा रडार:** ग्राहक चुनते ही उसका पिछला बकाया, स्वीकृत उधारी सीमा और नया कुल बकाया बिलिंग स्क्रीन पर तुरंत दिख जाता है।

### Cash Tender & Change Return Calculator (नकद छुट्टे पैसे कैलकुलेटर)
- **व्यस्त समय में ज़ुबानी हिसाब से मुक्ति:** नकद बिलिंग करते समय ग्राहक द्वारा दिए गए बड़े नोटों पर छुट्टे पैसे वापस करने का हिसाब लगाना अक्सर तनावपूर्ण होता है।
- **स्वचालित नोट बटन (Quick Tender Chips):** नकद भुगतान चुनते ही सिस्टम बिल रकम के आधार पर तुरंत सही नोट बटन सुझाता है (जैसे ₹164 के बिल पर ₹200, ₹500)।
- **वापस दें (Change Return) का बड़ा डिस्प्ले:** ग्राहक से मिले नोट पर टैप करते ही या रकम लिखते ही स्क्रीन पर बड़े हरे अक्षरों में साफ़ दिखता है: **"🤝 ग्राहक को वापस दें: ₹XX"**।
- **कम पैसे चेतावनी:** यदि ग्राहक ने बिल से कम पैसे दिए हैं, तो तुरंत लाल रंग में चेतावनी दिखती है कि कितने पैसे और लेने बाकी हैं। इससे मुनीम या दुकान पर बैठे नए लड़के से भी हिसाब में ₹1 की चूक नहीं होती।

### 0-Stock & Low-Stock Visual Highlights (0-स्टॉक व कम स्टॉक चेतावनी बैज)
- **स्पष्ट लाल रंग की 0-स्टॉक चिप:** यदि दुकान में किसी सामान का स्टॉक 0 हो चुका है, तो काउंटर ग्रिड में उस सामान के कार्ड पर लाल बॉर्डर और स्पष्ट **"⚠️ 0 स्टॉक (ख़त्म)"** का बैज चमकता है।
- **कम स्टॉक अंबर अलर्ट:** जब सामान न्यूनतम स्टॉक सीमा के नीचे पहुँचता है, तो अंबर रंग में **"कम: X बचा"** दिखाई देता है।
- **व्यावहारिक ग्रामीण काउंटर स्वतंत्रता:** गाँव की दुकानों में अक्सर नया बोरा दुकान में आ चुका होता है पर कंप्यूटर में दर्ज होने में समय लगता है। इसलिए सिस्टम बिलिंग को ब्लॉक नहीं करता, लेकिन लाल बैज दिखाकर दुकानदार को सचेत कर देता है कि स्टॉक अपडेट करना बाकी है।
...
### 1-Click Store Onboarding Wizard & Customizable Rural Kirana Catalog (दुकान सेटअप विज़ार्ड व कस्टमाइज़ेबल किराना सामान)
...
### 14-Day Complimentary Pro Trial (🎁 14-दिन मुफ़्त प्रो ट्रायल)
- **नए दुकानदारों के लिए 100% मुफ़्त स्वागत अनुभव:** जैसे ही कोई नया दुकानदार अपनी दुकान पहली बार पंजीकृत करता है, उसे बिना किसी भुगतान, क्रेडिट कार्ड या बैंक विवरण के पूरे 14 दिनों के लिए 'ग्रामिन प्रो' की सभी उन्नत सुविधाएं मुफ़्त उपलब्ध कराई जाती हैं।
- **सभी प्रो सुविधाएं खुली:** 14 दिनों के दौरान दुकानदार क्लाउड बैकअप, मुनीम PIN सुरक्षा, WhatsApp तगादा संदेश, और कम-स्टॉक अलर्ट का खुलकर लाभ ले सकते हैं।
- **ट्रायल समाप्ति पर कोई रुकावट नहीं:** 14 दिन पूरे होने के बाद भी दुकान का कामकाज, बिलिंग, बही-खाता या प्रिंटिंग कभी बंद नहीं होती। खाता स्वतः आजीवन मुफ़्त (Free) प्लान पर जारी रहता है। किसी भी पुराने डेटा का कोई नुकसान नहीं होता।

### Merchant "Refer & Earn 15 Days Free Pro" Program (दुकानदार रेफरल प्रोग्राम: 15 दिन प्रो मुफ़्त)
- **दुकानदारों के लिए आपसी साझेदारी व मुफ़्त प्रो कमाने का अवसर:**
  - प्रत्येक पंजीकृत दुकान को एक अनूठा रेफरल कोड प्रदान किया जाता है।
  - जब कोई दुकानदार अपने गाँव या पास के गाँव के किसी अन्य किराना दुकानदार को ऐप से जोड़ता है, तो दोनों को सीधा लाभ मिलता है:
    - **नए साथी दुकानदार को:** रजिस्ट्रेशन के समय रेफरल कोड दर्ज करने पर 14 दिन ट्रायल के साथ +15 दिन अतिरिक्त, यानी कुल **29 दिन प्रो मुफ़्त** मिलते हैं।
    - **रेफर करने वाले पुराने दुकानदार को:** उनके खाते में तुरंत **+15 दिन अतिरिक्त प्रो प्लान** जुड़ जाता है (यदि वर्तमान में मुफ़्त प्लान में हैं, तो तुरंत प्रो सक्रिय हो जाता है)।
- **1-क्लिक व्हाट्सएप शेयरिंग:** प्लान विंडो में बने **"WhatsApp पर शेयर करें"** बटन पर टैप करते ही तैयार संदेश खुल जाता है जिसे सीधे अन्य किराना संघ या दुकानदार मित्रों को भेजा जा सकता है।
- **पारदर्शी रेफरल ट्रैकर:** दुकानदार अपनी प्लान विंडो में कभी भी देख सकते हैं कि उन्होंने कितने नए साथियों को जोड़ा है और कुल कितने प्रो बोनस दिन कमाए हैं।

### Direct Dynamic UPI QR Code & Instant Pro Upgrade (डायरेक्ट UPI QR कोड व 1-टैप प्रो अपग्रेड)

गाँव के दुकानदारों को ऑनलाइन कार्ड या जटिल नेटबैंकिंग के झंझट से पूरी तरह मुक्त रखते हुए, ग्रामीण किराना में **डायरेक्ट डायनेमिक UPI पेमेंट गेटवे** की सुविधा दी गई है:

1. **योजना व छूट अवधि का चयन:**
   - **१ महीना:** ₹99
   - **३ महीने (सर्वाधिक लोकप्रिय):** ₹269 (10% बचत — मात्र ₹89/माह)
   - **१ वर्ष (12 माह):** ₹999 (16% भारी छूट — मात्र ₹83/माह)

2. **स्वचालित डायनेमिक UPI QR कोड:**
   - अवधि चुनते ही स्क्रीन पर तुरंत उच्च-कंट्रास्ट वाला साफ UPI QR कोड बनकर तैयार हो जाता है।
   - इसमें तय राशि और दुकान का नाम पहले से भरा रहता है, जिससे दुकानदार या ग्राहक को अलग से राशि टाइप करने की कोई ज़रूरत नहीं होती।
   - इसे PhonePe, Google Pay, Paytm, BHIM, CRED या किसी भी बैंक UPI ऐप से सीधे स्कैन किया जा सकता है।

3. **मोबाइल पर 1-टैप सीधा भुगतान लिंक:**
   - यदि दुकानदार अपने उसी मोबाइल पर काम कर रहे हैं जिसमें उनका Google Pay / PhonePe स्थापित है, तो उन्हें QR स्कैन करने की भी ज़रूरत नहीं है।
   - स्क्रीन पर बने **"📲 1-टैप UPI ऐप खोलें"** बटन पर क्लिक करते ही फोन का UPI ऐप सीधे ₹99/₹269/₹999 के पूर्व-निर्धारित भुगतान के साथ खुल जाता है।

4. **12-अंकों का UTR / रेफरेंस नंबर सत्यापन:**
   - सफल भुगतान होने पर बैंक SMS या UPI ऐप की रसीद में दिखने वाला 12-अंकों का UTR नंबर दर्ज करें और **"भुगतान क्लेम सबमिट करें"** दबाएं।
   - सबमिट करते ही क्लेम समीक्षाधीन हो जाता है और व्यवस्थापक द्वारा सत्यापन होते ही प्रो प्लान स्वतः सक्रिय हो जाता है।

5. **बचे हुए दिन नहीं कटते (Automatic Day Stacking Guarantee):**
   - यदि किसी दुकान का प्रो प्लान पहले से चालू है और अभी 15 दिन बाकी हैं, और वे 3 महीने (90 दिन) का नया रिचार्ज करते हैं, तो उनके बचे हुए 15 दिन कभी नष्ट नहीं होते! नया प्लान मौजूदा समाप्ति तिथि के आगे जुड़कर पूरे 105 दिनों तक वैध हो जाता है।

6. **ऑफ़लाइन क्लेम सुरक्षा (Offline Resilience):**
   - यदि गाँव में अस्थायी रूप से इंटरनेट बंद हो, तब भी UTR नंबर स्थानीय रूप से सुरक्षित सहेज लिया जाता है। जैसे ही नेटवर्क दोबारा आता है, यह बिना किसी झंझट के अपने आप सर्वर पर चला जाता है।

7. **मुनीम / काउंटर स्टाफ सुरक्षा पहरा:**
   - काउंटर स्टाफ (मुनीम) मोड में प्रो अपग्रेड क्लेम सबमिट करना वर्जित है; केवल मुख्य दुकान संचालक (मालिक) ही अपने लॉगिन से भुगतान क्लेम सबमिट कर सकते हैं।

8. **अस्वीकृति के बाद पुनः सुधार व सबमिशन (Re-submission after Rejection):**
   - यदि किसी कारणवश UTR नंबर दर्ज करने में टाइपिंग की त्रुटि हो जाए और व्यवस्थापक उसे अस्वीकृत कर दें, तो दुकानदार बिना किसी रुकावट के तुरंत सही UTR दर्ज करके संशोधित क्लेम सबमिट कर सकते हैं।

9. **यूनिवर्सल NPCI UPI मानक संगतता (Universal Bank Compatibility):**
   - QR कोड और 1-टैप लिंक राष्ट्रीय भुगतान निगम (NPCI) के मानकों के अनुरूप सुरक्षित व संक्षिप्त संदेश के साथ बनाए गए हैं, जिससे किसी भी पुराने अथवा नए स्मार्टफोन पर PhonePe, Google Pay, Paytm, BHIM या बैंक ऐप में कोई रुकावट नहीं आती।

10. **सक्रिय बैंक खाता सुरक्षा व शालीन वैकल्पिक व्यवस्था (Graceful Fallback When Unconfigured):**
   - जब तक प्लेटफ़ॉर्म ऑपरेटर द्वारा आधिकारिक चालू खाता UPI आईडी सक्रिय नहीं की जाती, सिस्टम कोई भी फ़र्ज़ी अथवा अमान्य QR कोड प्रदर्शित नहीं करता ताकि बैंकिंग ऐप में भुगतान असफलता न हो।
   - ऐसी स्थिति में दुकानदारों को सीधे WhatsApp हेल्पलाइन सहायता या अधिकृत डिस्ट्रीब्यूटर से प्राप्त ऑफ़लाइन वाउचर कोड द्वारा तुरंत प्रो प्लान सक्रिय करने का स्पष्ट व सरल विकल्प मिलता है।

### Offline Voucher & Coupon Redemption (कूपन व एक्टिवेशन कोड से तुरंत प्रो चालू करें)
- **ऑफ़लाइन एक्टिवेशन वाउचर (Single-Use Activation Vouchers):** गाँव की दुकानों को डिजिटल पेमेंट गेटवे या ऑनलाइन कार्ड ट्रांजेक्शन की अनिवार्यता से मुक्त रखा गया है।
- **सुरक्षित सिंगल-यूज़ स्क्रैच-कार्ड मॉडल:** प्लेटफ़ॉर्म व्यवस्थापक या अधिकृत डिस्ट्रीब्यूटर द्वारा प्रदान किए जाने वाले कूपन कोड (जैसे: `GK-XXXX-XXXX`) सिंगल-यूज़ होते हैं। एक बार किसी दुकान द्वारा कोड रिडीम करने के बाद वह कोड स्थायी रूप से उपयोग हो चुका दर्ज हो जाता है और दोबारा किसी भी डिवाइस या दुकान द्वारा पुनः उपयोग नहीं किया जा सकता।
- **कूपन कोड दर्ज करना व प्रो सक्रिय करना:**
  1. हेडर या सेटिंग्स में जाकर **"सुविधाएं व प्लान"** या **"प्रो"** बैज पर क्लिक करें।
  2. नीचे बने **"कूपन या वाउचर कोड है? (Single-Use Voucher)"** बटन पर टैप करें।
  3. डिस्ट्रीब्यूटर या एडमिन से प्राप्त आधिकारिक कूपन कोड (जैसे: `GK-XXXX-XXXX`) दर्ज करें।
  4. **"लागू करें"** दबाते ही सत्यापन के पश्चात आपकी दुकान के लिए प्रो प्लान तुरंत सक्रिय हो जाता है।
- **दिन जुड़ना व शेष दिनों की सुरक्षा (Safe Day Stacking):** यदि आपकी दुकान का प्रो प्लान पहले से चालू है और उसमें दिन शेष हैं, तो नया वाउचर लागू करने पर पुराने बचे हुए दिन नष्ट नहीं होते; नई अवधि (उदा: +1 माह, +3 माह) वर्तमान प्लान के आगे स्वतः जुड़ जाती है।
- **1-क्लिक WhatsApp कूपन हेल्पलाइन (Request Coupon on WhatsApp):** यदि किसी दुकानदार के पास ऑफ़लाइन एक्टिवेशन कोड नहीं है, तो वे सीधे अधिकृत प्लेटफ़ॉर्म सहायता टीम से नया कूपन कोड प्राप्त करने के लिए व्हाट्सएप पर संपर्क कर सकते हैं।
- **वैधता व उल्टी गिनती (Days Remaining Countdown):** प्रो प्लान सक्रिय होने पर हेडर व प्लान विंडो में स्पष्ट दिखाई देता है कि आपकी योजना में कितने दिन बाकी हैं (जैसे: `👑 प्रो (28 दिन शेष)`), ताकि आप समय रहते नवीनीकरण कर सकें।

### Pro Feature Guards & 1-Tap Upgrade Doors (प्रो सुविधा सुरक्षा व त्वरित अपग्रेड)
- **सहज 1-टैप मार्ग:** जब मुफ़्त प्लान का उपयोग कर रहे दुकानदार किसी प्रो सुविधा (जैसे: बही-खाता में *"सभी को WhatsApp तगादा"* या रिपोर्ट में *"माहवारी लाभ-हानि"*) पर टैप करते हैं, तो कोई तकनीकी त्रुटि नहीं आती।
- **पारदर्शी सुविधा झलक:** बटन दबाते ही पारदर्शी प्लान विंडो खुल जाती है, जहाँ दुकानदार देख सकते हैं कि यह सुविधा दुकान के कारोबार को कैसे बढ़ाएगी, और वे व्हाट्सएप अथवा कूपन कोड से 1 टैप में इसे सक्रिय कर सकते हैं।
...
- **बाद में याद दिलाएं (Dismiss Option):** यदि काउंटर पर ग्राहकों की कतार लगी हो और दुकानदार तुरंत रीफ्रेश नहीं करना चाहते, तो बैनर पर बना **`✕`** बटन दबाकर इसे तुरंत हटा सकते हैं। काम पूरा होने के बाद अगली बार ऐप खोलने पर नया वर्शन स्वतः उपलब्ध रहता है।
...
- **प्रवेश का माध्यम (सुविधाजनक व सुरक्षित प्रवेश):**
  - **होम स्क्रीन फुटर लिंक:** मुख्य लैंडिंग स्क्रीन के नीचे बने *"👑 सुपर एडमिन लॉगिन (Master Portal)"* लिंक पर क्लिक करके सीधे एडमिन पासवर्ड डायलॉग खोला जा सकता है।
  - **मेनू ड्रॉवर प्रवेश:** मुख्य काउंटर पर *"अधिक मेनू"* बटन दबाकर *"👑 सुपर एडमिन नियंत्रण"* विकल्प से तुरंत प्रवेश किया जा सकता है।
  - **गुप्त शॉर्टकट व URL:** अधिकृत तकनीकी कर्मचारी अपने ब्राउज़र URL में `?admin=1` या `#admin` जोड़कर अथवा कीबोर्ड पर `Ctrl + Shift + A` दबाकर भी एडमिन डायलॉग खोल सकते हैं।
  - अधिकृत मास्टर एडमिन सुरक्षा पासवर्ड दर्ज करते ही केंद्रीय कमांड सेंटर सक्रिय हो जाता है।
...
### UPI Payment Claims Verification & Instant Pro Activation (यूपीआई भुगतान सत्यापन व प्रो एक्टिवेशन)

जब ग्रामीण दुकानदार अपने काउंटर से QR कोड स्कैन कर 12-अंकों का UTR नंबर सबमिट करते हैं, तो व्यवस्थापक के पास उनके सत्यापन और प्रो एक्टिवेशन का पूर्ण नियंत्रण रहता है:

- **💳 लंबित UPI भुगतान टैब (Pending Claims Badge):**
  - जैसे ही कोई नया दुकानदार भुगतान क्लेम सबमिट करता है, सुपर एडमिन के डैशबोर्ड पर लाल रंग का ब्लिंकिंग बैज (जैसे: `💳 UPI भुगतान क्लेम (1 नए!)`) दिखाई देने लगता है।
- **त्वरित स्थिति फ़िल्टर (Status Filtering):**
  - **सभी (ALL):** अब तक के सभी दावों का पूरा इतिहास।
  - **⏳ लंबित (PENDING):** केवल वे दावे जिनका बैंक मिलान और सत्यापन होना बाकी है।
  - **✓ स्वीकृत (APPROVED):** सत्यापित और सक्रिय किए जा चुके दावे।
  - **✕ अस्वीकृत (REJECTED):** अमान्य या बैंक में राशि न मिलने वाले दावे।
- **1-क्लिक UTR कॉपी व बैंक खाता मिलान:**
  - प्रत्येक क्लेम कार्ड पर दुकानदार का नाम, गाँव, फोन नंबर, चुनी गई योजना (1 माह ₹99, 3 माह ₹269, 1 वर्ष ₹999) और 12-अंकों का UTR नंबर स्पष्ट प्रदर्शित होता है।
  - UTR के पास बने कॉपी बटन पर क्लिक करते ही नंबर क्लिपबोर्ड पर कॉपी हो जाता है, जिससे व्यवस्थापक अपने बैंक/UPI स्टेटमेंट में आसानी से खोज सकते हैं।
- **1-क्लिक प्रो एक्टिवेशन व स्वचालित दिन जोड़ना (Approve with Stacking):**
  - बैंक में राशि सत्यापित होते ही व्यवस्थापक **"✓ प्रो सक्रिय करें (Approve)"** बटन दबाते हैं।
  - **दिन जुड़ने की गारंटी:** यदि दुकान पहले से प्रो प्लान में है, तो व्यवस्थापक द्वारा स्वीकृत किए जाने पर उसके शेष बचे दिनों में नई अवधि (उदा: +90 दिन) जुड़ जाती है।
  - **रीयल-टाइम सिंक:** दुकान को लॉगआउट या ऐप बंद करने की आवश्यकता नहीं होती; पृष्ठभूमि सिंक के माध्यम से उनका काउंटर तुरंत प्रो सुविधाओं के साथ सक्रिय हो जाता है।
- **कारण सहित अस्वीकृति व दुकानदार को स्पष्ट सूचना (Reject with Reason):**
  - यदि किसी क्लेम का UTR अमान्य हो या बैंक खाते में पैसा न पहुँचा हो, तो व्यवस्थापक **"✕ अस्वीकृत"** बटन दबाकर पूर्व-निर्धारित कारण (जैसे: *"बैंक खाते में इस UTR से भुगतान प्राप्त नहीं हुआ"* या *"प्राप्त राशि प्रो शुल्क से कम है"*) चुन सकते हैं।
  - यह कारण दुकानदार के स्क्रीन पर तुरंत पारदर्शी रूप से प्रदर्शित होता है ताकि वे सही UTR दर्ज कर सकें या सहायता ले सकें।
- **1-टैप दुकानदार व्हाट्सएप संपर्क:**
  - किसी भी संदेह की स्थिति में व्यवस्थापक सीधे क्लेम कार्ड पर बने व्हाट्सएप बटन से दुकानदार को तुरंत संदेश भेज सकते हैं।

### Single-Use Pro Voucher Management & Anti-Bypass System (सिंगल-यूज़ प्रो वाउचर प्रबंधन व सुरक्षा)

सुपर एडमिन डैशबोर्ड पर अब सिंगल-यूज़ प्रो वाउचर का पूर्ण और सुरक्षित प्रबंधन उपलब्ध है, जिससे ऑफलाइन नकद वितरण या डिस्ट्रीब्यूटर नेटवर्क के माध्यम से प्रो प्लान कोड जारी किए जा सकते हैं:

- **सुरक्षित सिंगल-यूज़ वाउचर निर्माण (Voucher Generation):**
  - **🎟️ प्रो वाउचर टैब** में जाकर **"+ नया वाउचर कोड बनाएं"** बटन दबाएं।
  - अवधि का चयन: 1 महीना (₹99), 3 महीने (₹249), अथवा 1 वर्ष (₹899)।
  - मात्रा का चयन: एक साथ 1, 3, 5 या 10 वाउचर कोड सेकंडों में बनाए जा सकते हैं।
  - नोट/टिप्पणी: वाउचर के साथ दुकानदार या डीलर का नाम (जैसे: *"बिलासपुर डीलर"*, *"रमेश किराना"*) जोड़ा जा सकता है।
- **सुरक्षित नॉन-रिपीट व एंटी-बाईपास गारंटी (Anti-Bypass Guarantee):**
  - प्रत्येक वाउचर कोड अद्वितीय और केवल एक बार उपयोग योग्य होता है।
  - जैसे ही कोई दुकानदार ऐप में कोड दर्ज करता है, वह सिस्टम में हमेशा के लिए उपयोग हो चुका दर्ज हो जाता है।
  - यदि कोई दुकानदार या अन्य व्यक्ति वही कोड दोबारा दर्ज करने का प्रयास करता है, तो सिस्टम उसे तुरंत अस्वीकार कर देता है।
- **1-क्लिक कॉपी व व्हाट्सएप शेयरिंग (Copy & WhatsApp Distribution):**
  - प्रत्येक कोड के बगल में बने कॉपी बटन पर क्लिक करते ही कोड क्लिपबोर्ड पर कॉपी हो जाता है।
  - **"व्हाट्सएप"** बटन दबाते ही दुकानदार को भेजने के लिए पूर्व-लिखित संदेश स्वतः तैयार हो जाता है जिसमें कोड और सक्रियण निर्देश शामिल होते हैं।
- **पारदर्शी स्थिति व रिडेम्पशन ऑडिट (Status & Store Audit):**
  - **सक्रिय / अप्रयुक्त:** वे वाउचर जो अभी तक किसी भी दुकान द्वारा रिडीम नहीं किए गए हैं।
  - **उपयोग हो चुके:** कोड किस दुकान द्वारा किस तारीख को रिडीम किया गया, इसका पूरा रिकॉर्ड कार्ड पर ही दिखाई देता है।
- **अप्रयुक्त वाउचर का सुरक्षित रद्दीकरण (Revoke / Delete):**
  - यदि कोई अप्रयुक्त वाउचर रद्द करना हो, तो एडमिन उसे हटा सकते हैं। पहले से उपयोग हो चुके कोड को हटाया या बदला नहीं जा सकता।

### Campaign & Festive Voucher Generation (त्योहारी व प्रमोशनल अभियान वाउचर)

- **त्योहारी व विशेष अभियानों के लिए वाउचर टैगिंग:**
  - सुपर एडमिन नए प्रो वाउचर बनाते समय एक विशिष्ट अभियान टैग (जैसे: `DIWALI-2026`, `FESTIVE-50`, `LAUNCH-OFFER`) दर्ज कर सकते हैं।
  - यह टैग प्रत्येक संबंधित वाउचर कार्ड पर स्पष्ट रूप से प्रदर्शित होता है, जिससे यह आसानी से ऑडिट किया जा सकता है कि कौन सा वाउचर किस प्रचार अभियान या ग्रामीण व्यापार मेले के तहत जारी किया गया था।
  - अभियान टैग की मदद से प्लेटफ़ॉर्म व्यवस्थापक विभिन्न प्रचार अभियानों की सफलता और वाउचर उपयोग दर का आसानी से विश्लेषण कर सकते हैं।

### Pro Subscription Intelligence, Days Countdown & Pause-Resume (प्रो सदस्यता विवरण, शेष दिन रडार व पॉज़-रिज़्यूम नियंत्रण)

सुपर एडमिन डैशबोर्ड पर अब प्रत्येक पंजीकृत दुकान कार्ड पर प्रो सदस्यता की पूरी स्थिति और समय सीमा रीयल-टाइम में प्रदर्शित होती है:

- **पूर्ण सदस्यता विवरण (360° Plan Intelligence):**
  - **शुरुआत तिथि (सब्सक्राइब कब किया):** दुकान ने प्रो प्लान किस दिन सक्रिय किया था, वह स्पष्ट रूप से प्रदर्शित होता है।
  - **योजना समाप्ति तिथि (कब तक वैध):** प्रो लाइसेंस की अंतिम तारीख स्पष्ट दिखाई देती है।
  - **शेष दिन उल्टी गिनती (Live Days Countdown Badge):**
    - **हरा बैज (15 दिन से अधिक शेष):** सुरक्षित और पूर्ण सक्रिय स्थिति।
    - **अंबर/नारंगी बैज (15 दिन या उससे कम शेष):** आसन्न समाप्ति चेतावनी, ताकि समय पर नवीनीकरण कराया जा सके।
    - **लाल बैज (समय समाप्त / Expired):** प्लान की अवधि समाप्त हो चुकी है।
    - **नीला बैज (फ्रीज / Paused):** सदस्यता अस्थायी रूप से रोकी गई है और शेष दिन सुरक्षित हैं।
  - **नवीनतम भुगतान संदर्भ (Latest Payment Claim):** दुकान द्वारा अंतिम बार किए गए भुगतान का UTR नंबर, राशि और सत्यापन स्थिति कार्ड पर ही दिखती है।
- **1-क्लिक प्रो रोकें (Pause Pro) व शून्य दिन नुकसान गारंटी (Zero-Day-Loss Guarantee):**
  - यदि कोई दुकानदार कुछ दिनों के लिए बाहर जा रहा है, दुकान अस्थायी रूप से बंद है, या तकनीकी कारणों से प्लान रोकना चाहता है, तो व्यवस्थापक **"प्रो रोकें (Pause Pro)"** बटन दबाकर प्लान को तुरंत फ्रीज कर सकते हैं।
  - **दिन फ्रीज होने का नियम:** प्लान रुकते ही दुकानदार के शेष बचे हुए दिन सुरक्षित हो जाते हैं। जब तक प्लान रुका रहेगा, तब तक कोई दिन बर्बाद नहीं होगा।
  - **रोकने का कारण:** एडमिन कारण चुन सकते हैं (जैसे: *दुकानदार का अनुरोध, भुगतान सत्यापन लंबित, दुकान अस्थायी बंद, आदि*)।
- **1-क्लिक प्रो पुनः चालू करें (Resume Pro):**
  - जैसे ही दुकानदार वापस आता है या भुगतान सत्यापित हो जाता है, **"प्रो चालू करें (Resume)"** बटन दबाते ही सुरक्षित किए गए सभी शेष दिन आज की तारीख से आगे स्वतः जुड़ जाते हैं।
- **1-क्लिक व्हाट्सएप नवीनीकरण तगादा (Renewal Reminder):**
  - जिन प्रो दुकानों की वैधता 7 दिन या उससे कम बची है, उनके कार्ड पर नारंगी रंग का **"तगादा (Reminder)"** बटन स्वतः प्रकट हो जाता है।
  - एक क्लिक में दुकानदार के व्हाट्सएप पर सम्मानजनक और स्पष्ट नवीनीकरण संदेश प्रेषित हो जाता है जिसमें शेष दिन और UPI नवीनीकरण की जानकारी शामिल होती है।
- **त्वरित फ़िल्टर बटन (Expiry Filter Chips):**
  - डैशबोर्ड पर 1-टैप में दुकानों को स्थिति के अनुसार छाँटने की सुविधा:
    - **सभी** (सभी पंजीकृत दुकानें)
    - **🚀 प्रो** (केवल प्रो लाइसेंस धारी दुकानें)
    - **🔥 7 दिन में समाप्त** (जिनके पास केवल 1 सप्ताह या कम समय बचा है)
    - **⏸️ रुके हुए** (जिनका प्रो प्लान फ्रीज/पॉज़ किया गया है)
    - **⌛ समाप्त** (जिनका प्रो समाप्त हो चुका है)
    - **🌾 स्टार्टर** (मुफ़्त ग्रामीण स्टार्टर दुकानें)

### Universal Bulk Store & Subscription Controls (सार्वभौमिक बल्क प्रो व स्टोर नियंत्रण)

सुपर एडमिन को आपातकालीन रखरखाव, सामूहिक ऑफ़र या सिस्टम अपग्रेड के दौरान पूरे राज्य के किराना स्टोरों पर एक साथ नियंत्रण के लिए सार्वभौमिक बल्क कंट्रोल बार प्रदान किया गया है:

- **⏸️ सभी प्रो रोकें (Pause All Pro):**
  - एक साथ पूरे प्लेटफ़ॉर्म की सभी सक्रिय प्रो दुकानों के प्लान को सुरक्षित रूप से फ्रीज कर देता है। सभी दुकानों के शेष दिन यथावत सुरक्षित रहते हैं।
- **▶️ सभी प्रो चालू करें (Resume All Pro):**
  - सभी रोकी गई दुकानों के प्लान को एक क्लिक में पुनः सक्रिय करता है और सभी के सुरक्षित दिन वर्तमान तारीख से आगे बढ़ा देता है।
- **⛔ सभी खाते निलंबित करें (Suspend All Accounts):**
  - संवेदनशील आपात स्थिति में पूरे प्लेटफ़ॉर्म के दुकान खातों को अस्थायी रूप से सुरक्षित लॉक कर देता है।
- **✓ सभी खाते सक्रिय करें (Activate All Accounts):**
  - सभी निलंबित खातों को सामान्य संचालन में वापस लाता है।
- **दो-चरणीय सुरक्षा पुष्टि (Two-Step Safety Guard):**
  - किसी भी बल्क क्रिया को चलाने से पहले सिस्टम प्रभावित दुकानों की कुल संख्या, विवरण और एडमिन से कारण दर्ज करने का अनिवार्य पुष्टिकरण मांगता है ताकि अनजाने में कोई त्रुटि न हो।

### Direct Merchant Support, PIN Reset Helpline & Plan Activation (दुकानदार सहायता, PIN रीसेट हेल्पलाइन व प्रो एक्टिवेशन)
...
- **1-क्लिक दुकानदार PIN रीसेट हेल्पलाइन (🔑 PIN रीसेट):**
  - यदि कोई ग्रामीण दुकानदार अपना 4-अंकों का गुप्त PIN भूल जाता है और हेल्पलाइन पर संपर्क करता है, तो व्यवस्थापक दुकान कार्ड पर बने चाबी आइकॉन (`🔑`) पर क्लिक करके तुरंत नया 4-अंकों का PIN सेट कर सकते हैं।
  - PIN रीसेट होते ही व्यवस्थापक को 1-टैप में दुकानदार के व्हाट्सएप पर नया PIN और सुरक्षित लॉगिन संदेश भेजने का विकल्प मिलता है।
- **1-क्लिक प्रो अपग्रेड/डाउनग्रेड (Plan Toggle & Duration Selection):**
  ...
  - **योजना अवधि चुनाव (1 महीना, 3 महीने, 1 वर्ष):** प्रो अपग्रेड करते समय व्यवस्थापक योजना की समय सीमा (1 महीना, 3 महीने या 12 महीने) चुन सकते हैं, जिससे समाप्ति तिथि स्वतः निर्धारित हो जाती है और दुकान कार्ड पर वैधता तिथि (जैसे: `📅 वैधता: 23/10/2026`) स्पष्ट दिखाई देती है।
- **दुकान स्थिति नियंत्रण (सक्रिय / निलंबित):**
  - यदि किसी दुकान का खाता अस्थायी रूप से निष्क्रिय करना हो या फिर से चालू करना हो, तो **"सक्रिय रखें"** अथवा **"खाता रोकें"** बटन से तुरंत नियंत्रित किया जा सकता है।

### Global Platform Broadcast System: All vs. Selected Stores (मंच लाइव घोषणाएं व ब्रॉडकास्ट प्रणाली: सभी व चुनी गई दुकानें)

प्लेटफ़ॉर्म सुपर एडमिन को पूरे राज्य के सभी ग्रामीण दुकानदारों के बिलिंग काउंटरों पर रीयल-टाइम लाइव बैनर घोषणाएं प्रसारित करने का पूर्ण नियंत्रण मिलता है:

- **दोहरा प्रसारण दायरा (Universal vs. Selective Targeting):**
  - **📢 सभी दुकानें (Universal Broadcast):** राज्य के सभी सक्रिय किराना काउंटरों पर एक साथ लाइव बैनर संदेश प्रसारित करें। (उदा: सर्वर रखरखाव सूचना, रक्षाबंधन या दिवाली की शुभकामनाएं, नए फीचर्स की घोषणा)।
  - **🎯 चुनी गई दुकानें (Selected Stores):** केवल आपकी चुनी हुई विशिष्ट दुकानों को लक्षित करके संदेश भेजें। (उदा: चुनिंदा दुकानों के लिए विशेष प्रो डिस्काउंट, किसी विशिष्ट इलाके के दुकानदारों के लिए स्थानीय मंडी अलर्ट)।
- **दुकान चयन सूची व त्वरित खोज:**
  - "चुनी गई दुकानें" मोड में एडमिन को दुकान के नाम, संचालक के नाम, फ़ोन नंबर या जिले से तुरंत खोजने और चेकबॉक्स द्वारा एक-एक दुकान चुनने की सुविधा मिलती है। "सभी चुनें" और "साफ करें" बटन से सेकंडों में समूह तैयार किया जा सकता है।
- **विशिष्ट श्रेणी व जिला फ़िल्टर (Optional Plan & District Filters):**
  - घोषणा को केवल मुफ़्त (FREE) या केवल प्रो (PRO) दुकानों तक सीमित किया जा सकता है।
  - राज्य के किसी एक विशिष्ट जिले (जैसे: केवल बस्तर या केवल रायपुर) के दुकानदारों के लिए भी घोषणा प्रसारित की जा सकती है।
- **4 प्रकार के रंगीन सूचना संकेत (4 High-Contrast Notice Types):**
  - **ℹ️ सामान्य सूचना (INFO - नीला रंग):** प्लेटफ़ॉर्म अपडेट, सामान्य मार्गदर्शन।
  - **⚠️ चेतावनी (WARNING - पीला/अंबर रंग):** बकाया नवीनीकरण, समय सीमा स्मरण।
  - **🚨 महत्वपूर्ण अलर्ट (ALERT - लाल/गुलाबी रंग):** तकनीकी आपातकाल, तत्काल निर्देश।
  - **🎉 खुशखबरी व ऑफ़र (SUCCESS - हरा/एमराल्ड रंग):** नए फ़ीचर, त्यौहार डिस्काउंट, विशेष योजनाएं।
- **लाइव काउंटर प्रीव्यू (What You See Is What They Get):**
  - घोषणा प्रसारित करने से पहले एडमिन उसी डायलॉग बॉक्स में लाइव बैनर का दृश्य देख सकते हैं कि दुकानदार की स्क्रीन पर यह कैसा दिखेगा।
- **स्वचालित समय सीमा समाप्ति (Auto-Expiry Duration):**
  - घोषणा को 1 दिन, 3 दिन, 7 दिन, 15 दिन या 30 दिन की अवधि के लिए सेट किया जा सकता है, जिसके बाद वह स्वतः समाप्त हो जाती है।
- **दुकानदार काउंटर पर आसान पावती (1-Tap Dismiss Guard):**
...
- **1-क्लिक स्प्रेडशीट निर्यात (📥 CSV डाउनलोड):**
  - फ़ील्ड समन्वयकों और ज़मीनी प्रचार टीम के लिए डैशबोर्ड पर **"CSV डाउनलोड"** बटन उपलब्ध है।
  - एक क्लिक में सभी पंजीकृत दुकानों की एक्सेल/सीएसवी शीट डिवाइस में डाउनलोड हो जाती है। इसमें दुकान का नाम, संचालक, मोबाइल नंबर, जिला, राज्य, वर्तमान प्लान, 14-दिन ट्रायल स्थिति, प्लान वैधता समाप्ति, शेष दिन, रेफरल कोड, जुड़े दुकानदार और अर्जित बोनस दिन आदि सभी आवश्यक विवरण शामिल रहते हैं।

### Store 360° Inspector & Granular Module Controls (360° दुकान नियंत्रण व मॉड्यूल स्विचबोर्ड)

सुपर एडमिन को प्रत्येक पंजीकृत दुकान पर सूक्ष्म स्तर पर नियंत्रण स्थापित करने के लिए '360° दुकान नियंत्रण' (Store 360° Inspector) प्रदान किया गया है:

- **360° स्टोर इंस्पेक्टर खिड़की (Store 360° Drawer):**
  - दुकान कार्ड पर बने **"नियंत्रण ⚙️"** बटन पर क्लिक करते ही उस विशिष्ट दुकान का व्यापक कंट्रोल पैनल खुल जाता है।
  - इसमें दुकान का नाम, संचालक, मोबाइल, वर्तमान प्लान, पंजीकरण तिथि और रीयल-टाइम डेटा संकलन (उत्पाद, ग्राहक, बिक्री, और डेटाबेस साइज़) एक नज़र में दिखाई देता है।
- **मॉड्यूल-दर-मॉड्यूल सुविधा नियंत्रण स्विच (Granular Feature Switches):**
  - किसी भी दुकान के लिए विशिष्ट सुविधाओं को व्यक्तिगत रूप से चालू या बंद किया जा सकता है:
    - 🎪 **साप्ताहिक हाट-बाज़ार मोड (Haat Bazaar Mode)**
    - 🖨️ **ब्लूटूथ थर्मल प्रिंटर (Thermal Printing)**
    - 🎙️ **बोलकर बिलिंग (Voice Billing Assistant)**
    - 📷 **कैमरा बारकोड स्कैनर (Camera Barcode Scanner)**
    - 🛡️ **खराबी व एक्सपायरी गार्ड (Spoilage Guard)**
    - 📋 **मंडी खरीदारी प्लानर (Mandi Restock Planner)**
  - *उपयोगिता:* किसी विशेष इलाके में ग्रामीण दुकानदार को बिना प्रो प्लान के भी ट्रायल के तौर पर कोई विशेष सुविधा दी जा सकती है या विशेष अनुरोध पर नियंत्रित की जा सकती है।
- **कस्टम कोटा सीमा नियंत्रण (Custom Quota Limits):**
  - यदि किसी सक्रिय ग्रामीण किराना स्टोर का व्यापार बड़ा है और वे डिफ़ॉल्ट सीमा से अधिक सामान या ग्राहक जोड़ना चाहते हैं, तो एडमिन उनके लिए विशेष सीमाएं निर्धारित कर सकते हैं:
    - अधिकतम उत्पाद सीमा (Max Products)
    - अधिकतम ग्राहक सीमा (Max Customers)
    - मासिक बिक्री सीमा (Max Monthly Sales)
- **मुनीम 4-अंकों का PIN रीसेट व व्हाट्सएप हेल्पलाइन (Munim PIN Recovery):**
  - यदि दुकान का मुनीम/स्टाफ अपना 4-अंकों का गुप्त PIN भूल जाता है, तो एडमिन इंस्पेक्टर पैनल से ही सीधे 4 अंकों का नया सुरक्षित PIN सेट कर सकते हैं और 1-क्लिक में दुकानदार को व्हाट्सएप पर भेज सकते हैं।

### Multi-Store Storage Footprint & Upgrade Lead Pipeline (डेटा स्टोरेज रडार व प्रो अपग्रेड एनालिटिक्स)

सुपर एडमिन डैशबोर्ड में **"💾 स्टोरेज व अपग्रेड रडार"** टैब जोड़ा गया है, जो पूरे राज्य की दुकानों के डेटाबेस उपयोग, संग्रहण भार और प्रो अपग्रेड संभावना का बुद्धिमान विश्लेषण करता है:

- **4 मुख्य स्वास्थ्य व क्षमता संकेतक (Storage Health KPIs):**
  - **कुल अनुमानित डेटा संग्रहण (Total Storage):** प्लेटफ़ॉर्म के सभी स्टोरों का कुल डेटा भार (KB / MB में)।
  - **कुल रिकॉर्ड्स (Total Records):** सभी दुकानों द्वारा जोड़े गए कुल उत्पाद, ग्राहक, बिक्री और खराबी प्रविष्टियों का योग।
  - **औसत दुकान क्षमता (Avg Capacity %):** ग्रामीण दुकानों द्वारा अपने अनुमत कोटे का औसत उपयोग प्रतिशत।
  - **🔥 हॉट अपग्रेड लीड्स (Hot Upgrade Leads):** वे उच्च-सक्रियता वाली दुकानें जो प्रो प्लान लेने के लिए पूरी तरह तैयार हैं।
- **संग्रहण वितरण पट्टी (Storage Distribution Strip):**
  - उत्पादों, ग्राहकों, बिक्रियों, खातों और खराबी रिकॉर्ड्स के अनुपात का स्पष्ट रंगीन विभाजन।
- **बुद्धिमान लीड वर्गीकरण (Smart Lead Categories):**
  - **🔥 हॉट अपग्रेड (HOT UPGRADE):** उच्च व्यापार मात्रा या 80%+ क्षमता उपयोग वाली दुकानें, जो प्रो प्लान की सबसे प्रबल दावेदार हैं।
  - **⚡ पावर मर्चेंट (POWER MERCHANT):** 500 से अधिक बिल काटने वाले बड़े व विश्वसनीय ग्रामीण व्यापारी।
  - **⚠️ कोटा सीमा के निकट (NEARING QUOTA):** जो मुफ़्त योजना की 75% से अधिक सीमा का उपयोग कर चुके हैं।
  - **🌾 नियमित (STEADY):** सामान्य व स्थिर गति से काम करने वाली दुकानें।
  - **💤 निष्क्रिय (DORMANT):** जिन्होंने खाता बनाया पर अभी सक्रिय व्यापार शुरू नहीं किया (पुनः संपर्क योग्य)।
- **1-क्लिक व्यक्तिगत व्हाट्सएप अपग्रेड प्रस्ताव (1-Click Personalized WhatsApp Pitch):**
  - प्रत्येक दुकान कार्ड पर **"📲 प्रो अपग्रेड प्रस्ताव"** बटन उपलब्ध है।
  - एक क्लिक में दुकानदार के आधिकारिक व्हाट्सएप पर उनके स्टोर के नाम, वर्तमान रिकॉर्ड संख्या और विशेष प्रो लाभों के साथ तैयार किया गया आकर्षक प्रस्ताव प्रेषित किया जा सकता है।
- **स्टोरेज व अपग्रेड एक्सेल शीट निर्यात (Storage CSV Export):**
  - **"📥 स्टोरेज रिपोर्ट CSV"** बटन से सभी दुकानों के स्टोरेज आंकड़े, रिकॉर्ड संख्या, उपयोग प्रतिशत और लीड श्रेणी की पूर्ण स्प्रेडशीट एक्सेल-अनुकूल प्रारूप (UTF-8 BOM) में डाउनलोड की जा सकती है।

### Safe Store Deletion & Test Cleanup (सुरक्षित टेस्ट दुकान निष्कासन)
- **टेस्ट व निष्क्रिय दुकान सफाई (🗑️ हटाएं):**
  - प्लेटफ़ॉर्म परीक्षण या गलती से बने फर्जी टेस्ट स्टोरों को हटाने के लिए प्रत्येक कार्ड पर सुरक्षित डिलीट बटन दिया गया है।
  - अनजाने में किसी असली दुकान का नुकसान न हो, इसके लिए सिस्टम सुरक्षा पुष्टि के रूप में दुकान का असली नाम दोबारा टाइप करने का अनिवार्य सुरक्षा कवच मांगता है।

### Proxy, Threat Intelligence & Fraud Radar (प्रॉक्सी, वीपीएन व धोखाधड़ी पहचान रडार)

ग्रामीण किराना सुपर एडमिन डैशबोर्ड में केंद्रीय सुरक्षा निगरानी हेतु **"🛡️ फ्रॉड रडार व सुरक्षा"** टैब उपलब्ध कराया गया है। यह व्यवस्था प्लेटफ़ॉर्म को अनधिकृत पहुँच, साइबर दुरुपयोग, फर्जी खातों और भुगतान विसंगतियों से पूरी तरह सुरक्षित रखती है:

- **4 मुख्य सुरक्षा संकेतक (Security Health Metrics):**
  - **उच्च जोखिम अलर्ट (High Risk Alerts):** वे खाते जिनमें संदिग्ध या असामान्य गतिविधियाँ दर्ज हुई हैं।
  - **प्रॉक्सी व वीपीएन पहचान (Proxy & VPN Hits):** गुमनाम इंटरनेट नेटवर्क या डेटासेंटर स्क्रिप्ट्स से की गई पहुँच का लाइव आंकड़ा।
  - **IP कोलिशन समूह (Shared IP Groups):** ऐसे नेटवर्क पते जहाँ से एक से अधिक दुकानें पंजीकृत या संचालित हो रही हैं।
  - **डुप्लीकेट UTR प्रयास (Duplicate Payment Alerts):** एक ही बैंक संदर्भ संख्या (12-अंक UTR) को कई दुकानों पर दोबारा इस्तेमाल करने की कोशिशों का पता लगाना।
- **जोखिम स्कोर मीटर (Risk Score Meter 0–100):**
  - प्रत्येक दुकान के उपयोग के आधार पर सुरक्षा स्कोर आंका जाता है:
    - **🟢 सुरक्षित (SAFE: 0–24):** सामान्य ग्रामीण मोबाइल नेटवर्क व स्वाभाविक व्यापार।
    - **🟡 संदिग्ध (SUSPICIOUS: 25–59):** साझा नेटवर्क या बार-बार गलत PIN प्रयास।
    - **🔴 उच्च जोखिम व फ्रॉड (HIGH RISK / FRAUD: 60–100):** प्रॉक्सी का उपयोग, डुप्लीकेट भुगतान या फर्जी ट्रायल चक्र।

### Multi-Store IP Collision & CSC Village Kiosk Detection (समान IP पर कई दुकानें व ग्रामीण CSC कियोस्क पहचान)

- **ग्रामीण नेटवर्क व CSC कियोस्क की समझ:**
  - ग्रामीण भारत में कई मोबाइल उपभोक्ता एक ही सेल्युलर टावर साझा करते हैं, या ग्राम पंचायत के कॉमन सर्विस सेंटर (CSC / VLE) से कई दुकानदार अपनी दुकान सेट करवाते हैं।
  - सिस्टम केवल एक नेटवर्क पर कई दुकानें होने से किसी को गलत साबित नहीं करता, बल्कि डिवाइस और पंजीकरण के समय का बुद्धिमानी से विश्लेषण करता है।
  - यदि अलग-अलग दिनों में अलग-अलग मोबाइलों से दुकानें जुड़ी हैं, तो यह वैध ग्रामीण व्यापार माना जाता है। यदि 5 मिनट के भीतर एक ही कंप्यूटर से बार-बार मुफ़्त ट्रायल खाते बनाए जा रहे हों, तो उसे तुरंत दुरुपयोग के रूप में फ्लैग किया जाता है।

### Duplicate UTR Payment Fraud Radar (समान UTR चोरी व धोखाधड़ी रोकथाम)

- **समान भुगतान रसीद की सुरक्षा:**
  - जब कोई दुकानदार प्रो प्लान के लिए 12-अंकों का UPI UTR नंबर सबमिट करता है, तो सुरक्षा रडार पूरे राज्य की सभी दुकानों में तुरंत जांच करता है।
  - यदि किसी ने किसी अन्य दुकान की रसीद या पहले से स्वीकृत UTR को दोबारा दर्ज करने की कोशिश की, तो अनुरोध तुरंत रुक जाता है और एडमिन डैशबोर्ड में उच्च-जोखिम धोखाधड़ी अलर्ट दर्ज हो जाता है।

### 1-Click Immediate Store Freeze & Unsuspend Controls (1-क्लिक तुरंत खाता निलंबन व बहाली)

- **तत्काल खाता रोक (⛔ Freeze Store):**
  - यदि किसी दुकान पर गंभीर धोखाधड़ी, डेटा चोरी या दुर्भावनापूर्ण गतिविधि पाई जाती है, तो सुपर एडमिन एक क्लिक में उसका खाता **निलंबित (Suspend)** कर सकते हैं।
  - खाता निलंबित होते ही:
    - दुकानदार और मुनीम दोनों का चालू लॉगिन सत्र तुरंत प्रभाव से समाप्त हो जाता है।
    - उस दुकान से कोई भी ऑनलाइन सिंक या नया लॉगिन स्वीकार नहीं किया जाएगा।
    - दुकान की स्क्रीन पर स्पष्ट संदेश दिखेगा कि खाता सुरक्षा समीक्षा हेतु रोका गया है।
- **त्वरित खाता बहाली (✅ Unsuspend Store):**
  - दुकानदार से बात होने व सत्यापन पूरा होने के बाद एडमिन एक क्लिक में खाता पुनः सक्रिय कर सकते हैं, जिससे उनका प्रो प्लान या पिछला डेटा बिना किसी नुकसान के तुरंत बहाल हो जाता है।
- **1-क्लिक व्हाट्सएप स्पष्टीकरण पूछताछ (WhatsApp Inquiry):**
  - एडमिन सीधे संबंधित दुकानदार के व्हाट्सएप पर एक पूर्व-लिखित, सम्मानजनक संदेश भेजकर उनकी दुकान का बोर्ड या रसीद मंगाकर सत्यापन कर सकते हैं।

### Live Platform Security Audit Log Stream (लाइव सुरक्षा ऑडिट लॉग व सत्यापन)

- **पारदर्शी सुरक्षा टाइमलाइन (Live Security Audit Stream):**
  - पंजीकरण, लॉगिन, गलत PIN प्रयास, भुगतान क्लेम और एडमिन की कार्रवाइयों की समयबद्ध सूची।
  - एडमिन किसी भी दुकान का नाम, फोन नंबर या नेटवर्क पता डालकर तुरंत उसका पूरा सुरक्षा इतिहास देख सकते हैं।
  - यह सुविधा 90 दिनों तक का सुरक्षित इतिहास रखती है और पुरानी प्रविष्टियाँ स्वतः साफ हो जाती हैं ताकि प्रणाली हमेशा तेज़ और हल्की बनी रहे।

### Mobile-First Admin Layout & Zero Horizontal Scroll (स्मार्टफोन-अनुकूल सुपर एडमिन लेआउट)

सुपर एडमिन डैशबोर्ड को ग्रामीण भारत के छोटे और मध्यम स्मार्टफोन्स (320px–480px) पर बिना किसी रुकावट या दाएँ-बाएँ स्क्रॉल (No Horizontal Scroll) के उपयोग हेतु विशेष रूप से अनुकूलित किया गया है:

- **2x3 टच ग्रिड नेविगेशन (Quick Tap Mobile Grid):**
  - मोबाइल स्क्रीन पर सभी 6 प्रमुख खंड (दुकानें, UPI क्लेम, प्रो वाउचर, घोषणाएं, स्टोरेज, फ्रॉड रडार) एक ही नज़र में 2-कॉलम टच ग्रिड में प्रदर्शित होते हैं।
  - किसी भी खंड में जाने के लिए स्क्रीन को दाएँ-बाएँ खींचने की आवश्यकता नहीं होती; आवश्यक सूचनाएं और नए क्लेम अलर्ट बैज सीधे संबंधित बटन पर दिखाई देते हैं।
- **फ्लूइड जिला व फिल्टर चिप्स (Responsive Filter Wrapping):**
  - छत्तीसगढ़ के सभी जिलों और वाउचर/स्टोरेज श्रेणियों के फिल्टर बटन स्क्रीन चौड़ाई के अनुसार स्वतः नई पंक्ति में व्यवस्थित हो जाते हैं, जिससे स्क्रीन से बाहर निकलने की समस्या समाप्त हो जाती है।
- **मास्टर ऑपरेशन्स ग्रिड (Touch-Friendly Master Controls):**
  - सामूहिक प्रो स्थगन, प्रो चालू, निलंबन और बहाली के बटन मोबाइल पर संतुलित 2x2 ग्रिड में व्यवस्थित होते हैं ताकि एक हाथ से आसानी से टैप किए जा सकें।
- **सुरक्षा ऑडिट लॉग का मोबाइल कार्ड प्रारूप (Stacked Security Cards):**
  - छोटे फोन पर चौड़ी 6-कॉलम टेबल के स्थान पर प्रत्येक सुरक्षा घटना (लॉगिन, नया पंजीकरण, भुगतान क्लेम) एक स्पष्ट वर्टिकल कार्ड के रूप में दिखती है।
  - कार्ड में घटना का प्रकार, समय, दुकान का नाम, जोखिम स्कोर और नेटवर्क जानकारी एक नज़र में बिना किसी हॉरिजॉन्टल स्क्रॉल के पढ़ी जा सकती है।
- **हाइब्रिड कंप्यूटर व टैबलेट व्यू:**
  - लैपटॉप व डेस्कटॉप पर विस्तृत क्षैतिज बार और पूर्ण स्प्रेडशीट टेबल स्वचालित रूप से सक्रिय रहते हैं, जिससे बड़ी स्क्रीन पर अधिकतम डेटा घनत्व मिलता है।
...
### Data Privacy Safeguards & High-Speed Platform Communication (डेटा गोपनीयता सुरक्षा व उच्च-गति मंच संचार)
- **गोपनीय PIN सुरक्षा ढाल (Zero Plaintext PIN Echo):**
  - जब भी कोई दुकानदार या मुनीम अपना गुप्त PIN भूल जाने पर एडमिन हेल्पलाइन से रीसेट करवाते हैं, तो नया 4-अंकों का PIN स्क्रीन संचार संदेशों में पूरी तरह ढका व सुरक्षित रहता है। नेटवर्क पर कोई भी अनाधिकृत प्रेक्षक या ब्राउज़र उपकरण इसे प्लेन टेक्स्ट में नहीं देख सकता, जिससे दुकानदारों के खातों की 100% सुरक्षा बनी रहती है।
- **न्यूनतम डेटा संचार व इंटरनेट बचत (Lean Data Transmission):**
  - दुकान सूची, सुरक्षा इतिहास, ग्राहक आंकड़े और बही-खाता सारांश लोड करते समय केवल वही आवश्यक जानकारी भेजी जाती है जो स्क्रीन पर दिखनी है। अनावश्यक आंतरिक कोड या भारी विवरणों को पहले ही हटा दिया जाता है, जिससे ग्रामीण क्षेत्रों में 2G/3G या कमजोर नेटवर्क पर भी ऐप पलक झपकते ही खुल जाती है और दुकानदार का इंटरनेट डेटा खर्च नहीं होता।
- **त्वरित बहु-दुकान सारांश (Instant Multi-Store Summary):**
  - सैकड़ों दुकानों का कुल सामान, ग्राहक संख्या, उधारी और बिक्री आंकड़े एक साथ कुछ ही मिलीसेकंड में गणना होकर प्रदर्शित होते हैं। बार-बार सर्वर से अलग-अलग प्रश्न पूछने के बजाय सामूहिक सारांश तैयार होता है, जिससे स्क्रीन पर कोई लोड या हैंग होने की समस्या नहीं आती।
- **स्मार्ट पृथक टैब लोडिंग (Isolated Tab Fetching):**
  - दुकानें, UPI क्लेम, वाउचर, लाइव घोषणाएं और सुरक्षा रडार के बीच स्विच करते समय केवल सक्रिय टैब का डेटा ही लोड होता है। एक टैब बदलने पर अन्य सभी टैब का डेटा व्यर्थ में दोबारा लोड नहीं होता, जिससे मोबाइल की बैटरी और डेटा दोनों की अधिकतम बचत होती है।
